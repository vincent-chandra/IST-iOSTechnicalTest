...
class MovieDetailsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        MovieInteractor.shared.AFMovieDetail(id: id) { data in
        ...
        MovieInteractor.shared.AFMovieTrailer(id: id) { data in
        ...
        MovieInteractor.shared.AFUserReview(page: currentPageReview, id: id) { data in
            DispatchQueue.main.async {
                self.arrReview = data
